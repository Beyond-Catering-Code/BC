      ...
      <section className="py-16 md:py-24 bg-white text-center" aria-label="Get In Touch">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-12">
            For inquiries, reservations, or to explore our culinary selections, contact Beyond Catering. Planning a corporate event, wedding, or private gathering? Our team is here to help.
          </p>
          <p className="mt-4 text-lg text-gray-600">
            We're excited to bring exceptional gastronomic experiences to your next event in Dubai.
          </p>
